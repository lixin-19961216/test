...
import com.iqianjin.test.teststage.testng.ReportUtil;
...
public class AssertUtil {
    ...
    public static void expectResponseIsNullOrEmpty () {
        try {
            Assert.fail("用例期望的返回体不能为空");
        } catch (Error e) {
            errors.add(e);
            flag = false;
            ReportUtil.log("用例期望的返回体expectResponse不能为空!");
        }
    }
